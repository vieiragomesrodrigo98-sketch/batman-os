...
from batman_os.capabilities.rules.a11y002_loader import SpecA11y002, carregar_especificacoes_a11y002
...
from batman_os.capabilities.rules.cto002_loader import SpecCto002, carregar_especificacoes_cto002
...
from batman_os.capabilities.rules.cto004_loader import SpecCto004, carregar_especificacoes_cto004
...
from batman_os.capabilities.rules.perf004_loader import (
    SpecPerf004,
...
from batman_os.cli.descoberta_arquivos import (
    ...
    entradas_cto002_para_regra,
    entradas_cto004_para_regra,
...
def _capabilities_a_registrar() -> list[tuple[CapabilityImplementation, dict[str, object]]]:
    ...
    return [
        ...
        (
            construir_implementacao_cto002(),
            {
                "caminho": "api/routers/nada.py",
                "conteudo": "x = 1\n",
                "regra": {
        ...
        (
            construir_implementacao_cto004(),
            {
                "caminho": "api/routers/nada.py",
                "conteudo": "x = 1\n",
                "regra": {
        ...
        (
            construir_implementacao_perf004(),
            {
                "caminho": "api/routers/nada.py",
                "conteudo": "x = 1\n",
                "regra": {
        ...
        (
            construir_implementacao_a11y002(),
            {
                "caminho": "frontend/src/Nada.tsx",
                "conteudo": "<div>nada aqui</div>\n",
                "regra": {
...
def _todas_especificacoes() -> list[_Especificacao]:
    ...
    especificacoes.extend(carregar_especificacoes_cto002())
...
def executar_scan(
    ...
    try:
        for item in especificacoes:
            ...
            elif isinstance(regra, RegraCto002Spec):
                entradas = entradas_cto002_para_regra(root, regra, item["descoberta"])
            elif isinstance(regra, RegraCto004Spec):
                entradas = entradas_cto004_para_regra(root, regra, item["descoberta"])
            elif isinstance(regra, RegraPerf004Spec):
